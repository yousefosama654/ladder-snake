...
public:
	...
	void SetPrisonCount(int prisoncount);
	int GetPrisonCount();
	...
	void DeductWallet(int deduction);
	void incrementWallet(int increment);
	void ResetPlayer(Grid* pGrid);
	void AddStation(Card*);
    Card* get_most_expensive_station();
